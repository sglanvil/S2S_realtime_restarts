...
def parse_command_line(args, description):
	...
	print(today_day)
	if (today_day == 1):
	    print("it's the first day of the month") # so go back and ping the last month
	    date = dt(today.year,today.month-1,1)
	    print(date)
	else:
	    print("it's NOT the first day of the month") # so just ping the current month
